...
export const SendMoney = () => {
    ...
    return <div class="flex justify-center h-screen bg-gray-300">
                <div className="h-full flex flex-col justify-center">
                    <div class="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                        ...
                        <div class="flex items-center space-x-4 mb-3">
                            ...
                            <h3 class="text-1xl font-semibold">transfer to {name}</h3>
                            <h3 class="text-1xl font-semibold">current balance : {balance}</h3>
                            </div>
